...
URL = 'https://www.avito.ru/murmanskaya_oblast/doma_dachi_kottedzhi/sdam-ASgBAgICAUSUA9IQ'
...
for p in range(1, 2):
    print(p)
    url = f"https://www.avito.ru/murmanskaya_oblast/doma_dachi_kottedzhi/sdam-ASgBAgICAUSUA9IQ?p={p}"
    ...
    if r.status_code == 200:
        ...
        if s != 0:
            ...
            print('Объектов нет')
print(data)
with open('avito.CottageHouseRent.json', 'w') as fout:
