...
URL = 'https://www.avito.ru/murmanskaya_oblast/kommercheskaya_nedvizhimost/prodam-ASgBAgICAUSwCNJW'
...
for p in range(1, 2):
    print(p)
    url = f"https://www.avito.ru/murmanskaya_oblast/kommercheskaya_nedvizhimost/prodam-ASgBAgICAUSwCNJW?p={p}"
    ...
    if r.status_code == 200:
        ...
        if s != 0:
            ...
            print('Объектов нет')
print(data)
with open('avito.CommercialRealEstateSale.json', 'w') as fout:
